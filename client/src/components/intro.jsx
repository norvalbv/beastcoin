  ...
  return (
    <div className="container">
      ...
      {/* <div className=" md:p-20"> */}
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-10 container-inner">
          ...
          <button className="buy">Buy on Pancake Swap</button>
          <button className="buy">Details</button>
          <p className="contract">0x16dCc0eC78E91e868DCa64bE86aeC62bf7C61037</p>
{/*   
